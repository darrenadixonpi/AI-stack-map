...
### UI 7 · No `og:image` meta tag — share links show blank previews ✅ Fixed (v1.7.0)

**File:** `index.html`, `public/og-image.svg`, `public/og-image.png`

OG + Twitter Card meta tags added to `index.html`. `public/og-image.svg` (1200×630,
dark gradient, 7-layer stack diagram, 52/49/7 stats) and rasterised
`public/og-image.png` created and committed.
...
### Road 6 · Stack comparison ("compare two sketches") ✅ Shipped (v1.7.0)
...
**Implemented:** "Fork & compare →" button forks the current sketch into two editable
columns. A layer diff table below highlights layers that differ in pick or phase.
Compare URLs (`#/sketch/compare/{encodedA}/{encodedB}`) encode both sketches and
survive page reload. "Edit A / Edit B" exits compare mode with the chosen sketch.
...
## Appendix — Validate Script Output (post-fix, v1.5.1)
...
## Appendix — Build Output (post-fix, v1.5.1)
...
## Appendix — Completed roadmap items (v1.5.1 → v1.7.0)

| Item | Status | Version |
|------|--------|---------|
| Stale content: Agentforce, Adept, CoCounsel | ✅ Fixed | v1.5.1 |
| Unchecked ApplicationCategoryId cast | ✅ Fixed | v1.5.1 |
| Dead CSS removed | ✅ Fixed | v1.5.1 |
| LayerDiagram semantic buttons | ✅ Fixed | v1.5.1 |
| GlobalSearch ARIA combobox + keyboard | ✅ Fixed | v1.5.1 |
| Tab bar overflow-x scroll | ✅ Fixed | v1.5.1 |
| Status badges on catalog entries | ✅ Shipped | v1.6.0 |
| 5 new stack tools (Bedrock, Mistral, Cohere, Together AI, Braintrust) | ✅ Shipped | v1.6.0 |
| Lazy-loaded pages | ✅ Shipped | v1.6.0 |
| Changelog in Overview | ✅ Shipped | v1.6.0 |
| Suggest-edit links on catalog cards | ✅ Shipped | v1.6.0 |
| Catalog empty-state + useTransition | ✅ Shipped | v1.6.0 |
| Pattern flow legend | ✅ Shipped | v1.6.0 |
| Sketch markdown LLM prompt suffix | ✅ Shipped | v1.6.0 |
| OG + Twitter Card meta + og-image.png | ✅ Shipped | v1.7.0 |
| Sketch compare ("Fork & compare") | ✅ Shipped | v1.7.0 |

---

*Generated by automated audit pass on 2026-06-12. All roadmap items through v1.7.0 verified.*
